...
public class MainActivity extends AppCompatActivity {
    ...
    Spinner spinner_to_currency, spinner_from_currency;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner_to_currency = (Spinner) findViewById(R.id.spinner_to_currency);
        spinner_from_currency = (Spinner) findViewById(R.id.spinner_from_currency);
